...
<style>
	...
	/*Media Queries*/
	@media (min-width:320px)  { .sig { overflow-y:scroll;height:210px } .siglogo { object-fit: cover;width: 100%;height: 400px; }/* smartphones, iPhone, portrait 480x320 phones */ }
	@media (min-width:481px)  {  .sig { overflow-y:scroll;height:380px } .siglogo { object-fit: cover;width: 100%;height: 400px; }/* portrait e-readers (Nook/Kindle), smaller tablets @ 600 or @ 640 wide. */ }
	@media (min-width:641px)  {  .sig { overflow-y:scroll;height:380px } .siglogo { object-fit: cover;width: 100%;height: 400px; } /* portrait tablets, portrait iPad, landscape e-readers, landscape 800x480 or 854x480 phones */ }
