...
<style>
	...
	@media (min-width:481px)  {  .sig { overflow-y:scroll;height:400px } /* portrait e-readers (Nook/Kindle), smaller tablets @ 600 or @ 640 wide. */ }
	@media (min-width:641px)  {  .sig { overflow-y:scroll;height:400px }/* portrait tablets, portrait iPad, landscape e-readers, landscape 800x480 or 854x480 phones */ }
	@media (min-width:961px)  { .caro { object-fit: cover;width: 100%;height: 600px; } .sig { overflow-y:scroll;height:400px } /* tablet, landscape iPad, lo-res laptops ands desktops */ }
	@media (min-width:1025px) { .caro { object-fit: cover;width: 100%;height: 600px; }  .sig { overflow-y:scroll;height:400px }/* big landscape tablets, laptops, and desktops */ }
	@media (min-width:1281px) { .caro { object-fit: cover;width: 100%;height: 600px; } .sig { overflow-y:scroll;height:400px } /* hi-res laptops and desktops */ }
