		  ...
		  <a class="btn btn-dark btn-sm btn-block" href="validate_event.php?name=update_arrange_id" role="button">update arrange id</a><br><br>
		  	<? for($j=$c2-1;$j>=0;$j--) { ?>
			    <div class="row">
				    ...
				    <div class="col m-2"><?=$arrange_id2[$i]?></div>
				    <div class="col m-2"><input type="number" class="form-control" id="arrange_id" placeholder="arrange id" name="arrange_id" value="<?=$arrange_id2[$i]?>" ></div>
